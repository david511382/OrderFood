...
-- -----------------------------------------------------
-- Table `orderfood_menu`.`size`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `orderfood_menu`.`size` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `orderfood_menu`.`item_size`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `orderfood_menu`.`item_size` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  INDEX `size_fk_idx` (`size_id` ASC) VISIBLE,
  CONSTRAINT `item_fk`
    FOREIGN KEY (`item_id`)
  ...
  CONSTRAINT `size_fk`
    FOREIGN KEY (`size_id`)
    REFERENCES `orderfood_menu`.`size` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
